  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // Must match the GitHub Pages base path so browser sees manifest as valid
        start_url: '/pon-simulator/',
        scope: '/pon-simulator/',
        categories: ['education', 'utilities'],
        icons: [
          {
            src: '/pon-simulator/icon-192.svg',
            sizes: '192x192',
            type: 'image/svg+xml',
            purpose: 'any',
          },
          {
            src: '/pon-simulator/icon-512.svg',
            sizes: '512x512',
            type: 'image/svg+xml',
            purpose: 'any',
          },
